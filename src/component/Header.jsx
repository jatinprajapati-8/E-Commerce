...
export default function Header() {
  ...
  return (
    <Disclosure
      as="nav"
      className="bg-[#00000012] h-[100px] sm:w-full w-[320px]"
    >
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
                    ...
                    {navigation.map((categary) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          "rounded-md px-3 py-2 mt-7 text-lg font-semibold"
                        )}
                        aria-current={categary.current ? "page" : undefined}
                      >
                        {categary.name}
                      </a>
                    ))}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="relative rounded-full bg-gray-200 p-1 text-white hover:text-gray-400 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
                        ...
                        {({ active }) =>
                          user ? (
                            <button
                              ...
                              className="mx-4 font-[300] text-[15px]"
                            >
                              logout
                            </button>
                          ) : (
